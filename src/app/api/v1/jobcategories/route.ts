...
import { JobCategoriesMaster } from '@/lib/global.types';

export const dynamic = 'force-dynamic';

const table = 'jobcategories';
const select = '*, jobcategories(*)';
...
export async function GET(request: Request) {
	...
	const { data, error } = await query.returns<JobCategoriesMaster[]>();
